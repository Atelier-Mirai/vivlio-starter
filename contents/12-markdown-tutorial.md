...
:::{.column}
**コラム見出し**
コラムの本文をここに記述します。視覚的に目立つ青色のボックスで表示されます。
:::
...
Vivlio Starter では、テキストと画像を美しく配置するための専用クラスが用意されています。
...
画像の右側に配置されるテキストです。テキスト側が2倍の幅になります。
:::

:::{.img-text3}
![画像説明](image.png)

画像の右側に配置されるテキストです。テキスト側が3倍の幅になります。
:::
```
...
:::{.text2-img}
テキストが左側に配置されます。テキスト側が2倍の幅になります。

![画像説明](image.png)
:::

:::{.text3-img}
テキストが左側に配置されます。テキスト側が3倍の幅になります。
...
```markdown
:::{.text-2dan}
これは二段組で表示されるテキストです。長い文章を効率的に配置でき、雑誌のようなレイアウトを実現できます。column-count: 2 と column-gap: 1.2em で設定されています。
