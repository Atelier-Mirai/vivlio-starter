...
| 画像名 | 花の見本 | 画像名 | 花の見本 |
|:---|:--------|:---|:--------|
| `suisen`<br>水仙 | ![suisen](suisen.webp) | `ume`<br>梅 | ![ume](ume.webp) |
| `nanohana`<br>菜の花 | ![nanohana](nanohana.webp) | `sakura`<br>桜 | ![sakura](sakura.webp) |
| `suzuran`<br>鈴蘭 | ![suzuran](suzuran.webp) | `ajisai`<br>紫陽花 | ![ajisai](ajisai.webp) |
| `asagao`<br>朝顔 | ![asagao](asagao.webp) | `himawari`<br>向日葵 | ![himawari](himawari.webp) |
| `kikyo`<br>桔梗 | ![kikyo](kikyo.webp) | `kosumosu`<br>秋桜 | ![kosumosu](kosumosu.webp) |
| `kiku`<br>菊 | ![kiku](kiku.webp) | `tsubaki`<br>椿 | ![tsubaki](tsubaki.webp) |
