...
<span class="caption">▼manifest.json</span>
...
`app.js` [^102] は次のように書かれています。

<span class="caption">▼app.js</span>
...
`sw.js` [^103]は次のように書かれています。

<span class="caption">▼sw.js</span>
...
[^103]: 出典: https://jam25.jp/javascript/about-pwa/, https://laboradian.com/create-offline-site-using-sw/
