...
## wave-studio のHTMLを眺める

本書で作成していく `wave-studio` のトップページは、次のような構造になっています：
...
完全なソースコードは、次章以降で段階的に組み上げていきます。また、GitHubの [wave-studio リポジトリ](https://github.com/Atelier-Mirai/wave-studio) からいつでもダウンロードできます。
