...
コンピュータ電子計算機と呼ばれます。アナログ計算機のほかにデジタル計算機もあります。アナログ計算機とは昔昔の機械式の計算機のことです。手回し式などの計算機がいろいろ発明されました。今日ではデジタル計算機をさすことが多いです。機械式計算機とも呼ばれます。

:::


![暮らしの中に生きるコンピュータ](kurashi.webp)
...
- **衣服**
    ...
    衣食住は、人が生きる上で生活の基盤となる要素です。大麻、木綿、絹糸、{古|いにしえ}の昔から日本人の身を{纏|まと}う衣服に用いられてきました。  
...
- **炊飯器**
    美味しい御飯を炊き上げてくれる炊飯器。「初めちょろちょろ、中ぱっぱ、赤子泣いてもふた取るな」と、朝早くから起きて{竃|かまど}で御飯を炊くのはなかなか難しいものでした。キャンプで{飯盒|はんごう}炊飯した経験をお持ちの方もいらっしゃると思いますが、火加減が難しく焦げになってしまったり芯が残ってしまったこともあるかと思います。火力の調整をしたり、毎朝御飯が炊き上がるためのタイマー機能など、小さなコンピュータ（マイコン）を組み込むことで、美味しい御飯を頂けるようになりました。
...
- **バス**
    通勤通学に電車やバスを利用する方も多いでしょう。例えば「さくら高校 行」と電光掲示板で行先表示したり、現金の他、ICカードを{翳|かざ}すことで乗車代金を払うことが出来ます。車両自体のガソリンや電気自動車の出力を制御する際や、バス停に「停留所を発車しました」と運行状況表示するなどの用途にも使われています。写真は、茨城県境町の「自動運転バス」 [^2] で、地域の足として活躍しています。


[^2]: [自治体初！境町で自動運転バスを定常運行しています](https://www.town.ibaraki-sakai.lg.jp/page/page002440.html)
