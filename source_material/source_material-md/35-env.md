...
Atom（アトム） は 「21世紀の高性能エディタ」 として GitHub（ギットハブ） により提供されていたエディタです。 Microsoft の買収により開発が滞りがちとなり、12月15日で提供終了となりました。Atomの遺産を受け継ぎ、コミュニティ有志により開発、提供されているエディタが、今回ご紹介する Windsurf（パルサー）です。
...
作業ディレクトリの作成方法や、Windsurf や Firefox の簡単な使い方の紹介です。 [^156]
