...
Netlifyは、小規模利用 [^154]なら無料でサイトを公開できるサービスです。
...
[^154]: Starterプラン(無料プラン)は、転送量: 100GB/月まで、容量: 100GB までです。作成した桜吹雪は約700kBの容量があります。単純計算ですが、毎日5000人が見るようになったら、有料プランへの移行を考えると良いでしょう。
