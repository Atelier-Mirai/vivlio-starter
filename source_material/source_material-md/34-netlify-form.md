...
https://github.com/Atelier-Mirai/wave_example/blob/master/contact.html にアクセスし、コピーしてください。
...
以下のコードは、
https://github.com/Atelier-Mirai/wave_example/blob/master/stylesheets/_form.css にあります。タイプし理解を深めても良いです。
...
![](form14.png)
Forms をクリックします。画面右に Active forms として、「contact」が表示されています。contact は、`<form name="contact">` と命名したことによるものです。
...
![](form27.png)
---
お問い合わせありがとうございました。表示されます。これは `<form action="/success">` と記述して `success.html` を表示するようにした効果です。
