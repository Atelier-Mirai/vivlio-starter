...
//image[zenhan][][width=90%]
//image[kouhan][][width=90%]
...
//image[contact][][width=90%]

  * 問い合わせ完了時の表示
//image[success2][][width=90%]

== その他いろいろ詰め合わせ

=== 桜吹雪を散らせる
//image[sakura_fubuki][][width=70%]

=== 固定フッターと追随メニュー
//image[fixed_and_follow_menu][][width=80%]
...
=== 種類ごとに絞り込む
//image[ramen_muuri][][width=55%]

=== グラフを描画する
//image[ramen_chart][][width=55%]
