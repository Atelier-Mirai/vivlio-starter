...
@<href>{https://developer.mozilla.org/ja/docs/Web/Progressive_web_apps,MDN Web Docs} により、引用して、掲載いたします。少し難しいなと感じられた方は、さらっと眺めていただいて実装方法に移っていただいても結構です。
//}
...
@<code>{content="WAVE"}は、ご自身の作成したアプリケーション名です。ここでは、「WAVE」としています。
