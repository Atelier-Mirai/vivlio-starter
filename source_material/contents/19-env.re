...
//sideimage[Windsurf_community][50mm][sep=5mm, side=R]{
...
@<small>{(実行すると「WindowsはあなたのPCを保護した」旨のメッセージが表示されます。「詳細」→「実行」をクリックすることで、Windsurfを起動出来ます。次回以降は、他のアプリと同様に起動できます。)}
...
@<code>{Ctrl + @<ruby>{,,カンマ}} を押すと、テキストエディタ @<ruby>{Windsurf,パルサー} の設定画面が開きます。
...
@<href>{https://raw.githubusercontent.com/Atelier-Mirai/Windsurf_config/master/keymap.cson} より、コピーすることも出来ます。
...
@<href>{https://raw.githubusercontent.com/Atelier-Mirai/Windsurf_config/master/snippets.cson}より、コピーして貼り付けてください。
