...
テキストエディタ @<ruby>{Pulsar,パルサー} の使い方をご説明する過程で、すでに以下のHTML を作成しています。とても短いコードですが、HTMLの基本が詰まっていますので、ご説明いたします。
...
//note[入力支援機能の活用]{
@<code>{<header>さくら</header>}を全て手入力しても良いですが、Pulsar には コーディングが容易に行えるよう「入力支援機能」が備わっています。
