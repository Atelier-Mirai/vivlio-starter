...
![](images/13-unit/units.webp){width=75% .float-right}

### メートルの起源

メートルの定義は、フランス革命時代（1792年）に始まります。フランス科学アカデミーは「地球の赤道から北極までの子午線の長さの1000万分の1」を1メートルと定義しました。

![](images/13-unit/meter.webp){width=40% .float-right}
...
![](images/13-unit/kilogram.webp){width=40% .float-right}
...
![](images/13-unit/time.webp){width=80% .float-right}
