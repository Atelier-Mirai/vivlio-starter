...
desc "新しい書籍プロジェクトを作成します。使い方: vs new <name> / rake new[name]"
task :new, [:name] do |t, args|
  ...
  puts "[vivlio-starter] Done. cd #{name} で移動し、執筆を開始できます。"
  puts "例: vivliostyle preview などのコマンドを実行"
end
