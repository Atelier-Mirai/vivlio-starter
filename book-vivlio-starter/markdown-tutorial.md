...
```html
<p>
  VFM is developed in the GitHub repository <sup>1</sup>.
  Issues are managed on GitHub <sup>2</sup>.
  Footnotes can also be written inline <sup>3</sup>.
</p>
<section class="footnotes" role="doc-endnotes">
  <hr>
  <ol>
    <li id="fn1"><a href="https://github.com/vivliostyle/vfm">VFM</a></li>
    <li id="fn2"><a href="https://github.com/vivliostyle/vfm/issues">Issues</a></li>
    <li id="fn3">This part is a footnote.</li>
  </ol>
</section>
```
...
| `hardLineBreaks` | `false` | 改行を `<br>` に変換する |
...
通常の VFM では、段落内の改行はスペースとして扱われます。`hardLineBreaks` を有効にすると、改行がそのまま `<br>` に変換されます。日本語の縦書きや詩的な文章に便利です。
