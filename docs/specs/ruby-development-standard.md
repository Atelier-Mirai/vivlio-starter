...
# Ruby 3.4+ Modern Development Standard
...
- Ruby 3.4.0 以上専用。旧バージョン互換は考慮しない。レガシー構文は破壊的に置き換える。
...
**「リファクタリング」の範囲**:
- 含まれる: Ruby 3.4+ イディオムへの変換、フェーズ区切りコメントの追加、不要な中継メソッドのインライン化。
...
- [ ] 副作用が局所化され、追跡可能か
- [ ] Ruby 3.4+ のイディオムで書けるところに古い書き方が残っていないか
