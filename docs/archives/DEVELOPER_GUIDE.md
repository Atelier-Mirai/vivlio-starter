...
Ruby 4.0 以降を前提として、開発中です。Samovarベースです。
...
# ========================================
commands:
  vfm: 'vfm'                 # VFM（Vivliostyle Flavored Markdown）コマンド

# ========================================
# ファイル設定
# ========================================
files:
  post_replace: 'post_replace_list.yml'  # 後処理用置換リストファイル
...
vivliostyle:
  ...
  quiet: true
  # 読み進め方向
  reading_progression: 'ltr'  # 'ltr': 左から右へ（横書き）, 'rtl': 右から左へ（縦書き）
  # エントリーファイル
