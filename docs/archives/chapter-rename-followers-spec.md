...
| Phase | 内容 | 状態 |
|---|---|---|
| 1 | `ChapterRename` の骨組み ＋ `catalog.yml`・画像ディレクトリの移設（挙動不変・重複解消） | **完了 2026-08-03** |
| 2 | R1・R2（辞書の `main:` と `scanned_chapters`） | **完了 2026-08-03** |
| 3 | R4（番号指定の設定の案内） | **完了 2026-08-03** |
