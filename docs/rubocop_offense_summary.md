...
- 集計日時: 2025-12-27 22:20 (UTC+09:00)
- 総違反件数: **675件**（前回 685件 → 10件減少）
...
| `lib/vivlio/starter/cli/cover.rb` | 24 | Lint/UnusedMethodArgument: 5件, Style/GuardClause: 4件, Lint/NonAtomicFileOperation: 2件 |
...
| `lib/vivlio/starter/cli/build/page_numberer.rb` | 11 | Layout/LineLength: 2件, Metrics/AbcSize: 2件, Lint/UnusedMethodArgument: 1件 |
...
| `lib/vivlio/starter/cli/glossary/add_commands.rb` | 11 | Metrics/AbcSize: 6件, Naming/PredicateMethod: 2件, Metrics/MethodLength: 1件 |
| `lib/vivlio/starter/cli/build/pipeline.rb` | 10 | Metrics/AbcSize: 3件, Layout/ExtraSpacing: 1件, Layout/LineLength: 1件 |
| `lib/vivlio/starter/cli/glossary/lint_commands.rb` | 10 | Metrics/AbcSize: 3件, Metrics/CyclomaticComplexity: 2件, Layout/EmptyLinesAfterModuleInclusion: 1件 |
...
| `lib/vivlio/starter/cli/post_process/footnote_converter.rb` | 5 | Style/IdenticalConditionalBranches: 2件, Layout/EmptyLineAfterGuardClause: 1件, Metrics/AbcSize: 1件 |
