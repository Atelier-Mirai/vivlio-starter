...
:::{.figure}
![](images/sample1b-img1.png?svgimg=40)
...
:::{.figure right}
![論理回路（Logic Circuit）](images/img2-logic.svg?svgimg=10,40,40)
:::
...
![半加算器（Half Adder）](images/img3-adder.svg){width=210 .float-right}
...
:::{figure}
![論理回路（Logic Circuit）](images/img2-logic.svg){width=200}
![半加算器（Half Adder）](images/img3-adder.svg){width=200}
:::
...
![von Neumann architecture](images/img4-neumann.svg){.float-bottom}
...
![digital analog](images/img5-digital.svg){.float-bottom}
...
![digital analog](images/img6-digital2.svg){width=300 .float-bottom}
...
![350dpiの写真](images/photo350dpi.png){width="136"}
![200dpiの写真](images/photo200dpi.png){width="136"}
![96dpiの写真](images/photo96dpi.png){width="136"}
