...
| 画像名 | 花の見本 | 画像名 | 花の見本 |
|:---|:--------|:---|:--------|
| `ajisai`<br>紫陽花 | ![ajisai](ajisai.webp) | `ajisai2`<br>紫陽花2 | ![ajisai2](ajisai2.webp) |
| `asagao`<br>朝顔 | ![asagao](asagao.webp) | `asagao2`<br>朝顔2 | ![asagao2](asagao2.webp) |
| `carnation`<br>カーネーション | ![carnation](carnation.webp) | `carnation2`<br>カーネーション2 | ![carnation2](carnation2.webp) |
| `carnation3`<br>カーネーション3 | ![carnation3](carnation3.webp) | `cosmos`<br>コスモス | ![cosmos](cosmos.webp) |
| `cosmos2`<br>コスモス2 | ![cosmos2](cosmos2.webp) | `hasu`<br>蓮 | ![hasu](hasu.webp) |
| `hasu2`<br>蓮2 | ![hasu2](hasu2.webp) | `himawari`<br>ひまわり | ![himawari](himawari.webp) |
| `himawari2`<br>ひまわり2 | ![himawari2](himawari2.webp) | `himawari3`<br>ひまわり3 | ![himawari3](himawari3.webp) |
| `himawari4`<br>ひまわり4 | ![himawari4](himawari4.webp) | `kasumisou`<br>かすみ草 | ![kasumisou](kasumisou.webp) |
| `kiku`<br>菊 | ![kiku](kiku.webp) | `kiku2`<br>菊2 | ![kiku2](kiku2.webp) |
| `kiku3`<br>菊3 | ![kiku3](kiku3.webp) | `kikyo`<br>桔梗 | ![kikyo](kikyo.webp) |
| `nanohana`<br>菜の花 | ![nanohana](nanohana.webp) | `nanohana2`<br>菜の花2 | ![nanohana2](nanohana2.webp) |
| `rengesou`<br>レンゲ草 | ![rengesou](rengesou.webp) | `sakura`<br>桜 | ![sakura](sakura.webp) |
| `sakura2`<br>桜2 | ![sakura2](sakura2.webp) | `sakura3`<br>桜3 | ![sakura3](sakura3.webp) |
| `suisen`<br>水仙 | ![suisen](suisen.webp) | `suisen2`<br>水仙2 | ![suisen2](suisen2.webp) |
| `suisen3`<br>水仙3 | ![suisen3](suisen3.webp) | `tanpopo`<br>たんぽぽ | ![tanpopo](tanpopo.webp) |
| `tsubaki`<br>椿 | ![tsubaki](tsubaki.webp) | `tulip`<br>チューリップ | ![tulip](tulip.webp) |
| `tulip2`<br>チューリップ2 | ![tulip2](tulip2.webp) | `wakaba`<br>若葉 | ![wakaba](wakaba.webp) |
| `wakaba2`<br>若葉2 | ![wakaba2](wakaba2.webp) | `yuri`<br>百合 | ![yuri](yuri.webp) |
...
シンプルスタイルでは、テーマカラーが章扉や節見出しの主要な装飾要素となります。書籍のジャンルに合わせて適切な色を選択しましょう。
...
|------|--------|-------|-----------|
| **暖色系** | | | |
| yellow | ![yellow](yellow.svg) | `#f1c40f` | 明るい技術書 |
| amber | ![amber](amber.svg) | `#f39c12` | 親しみやすい入門書 |
| orange | ![orange](orange.svg) | `#e67e22` | 実用的なガイドブック |
| peach | ![peach](peach.svg) | `#fab1a0` | 創作・エッセイ |
| coral | ![coral](coral.svg) | `#ff7675` | 温かみのある解説書 |
| red | ![red](red.svg) | `#e74c3c` | 注意喚起・重要事項 |
| magenta | ![magenta](magenta.svg) | `#e84393` | デザイン・芸術系 |
| plum | ![plum](plum.svg) | `#a29bfe` | 上品で個性的な内容 |
| **寒色系** | | | |
| purple | ![purple](purple.svg) | `#9b59b6` | 学術・専門書 |
| indigo | ![indigo](indigo.svg) | `#6c5ce7` | 知的・ビジネス書 |
| navy | ![navy](navy.svg) | `#2c3e50` | 信頼感・公式文書 |
| blue | ![blue](blue.svg) | `#3498db` | 技術・教育書 |
| cyan | ![cyan](cyan.svg) | `#00b894` | モダン・先進的内容 |
| teal | ![teal](teal.svg) | `#00cec9` | 洗練されたデザイン書 |
| mint | ![mint](mint.svg) | `#55efc4` | 清新・健康関連 |
| green | ![green](green.svg) | `#00b894` | 自然・環境系 |
| lime | ![lime](lime.svg) | `#fdcb6e` | 明るい参考書 |

**HEX表記**：`#ff0000` のように直接色コードを指定も可能です。
<!-- 
**ビジネス・技術書向け**
- `navy` - 信頼感のある深い紺色
- `indigo` - 知的な印象の藍色
