...
以下に、本書で使えるレイアウト用コンテナの実例を示します（Vivliostyle Flavored Markdown（VFM）の `:::` 記法）。用途に応じて選択してください。

### 写真のタイル配置（`pictures`）
ページ幅に応じて自動的に2〜3列に整列します。

:::{.pictures}
![発見の瞬間](images/81-install/Einstein.webp)
![研究ノート](images/81-install/photon.webp)
:::

:::{.pictures}
![発見の瞬間](images/81-install/Einstein.webp)
![研究ノート](images/81-install/photon.webp)
![実験装置](images/81-install/blackboard.webp)
:::
...
:::{.img-text}
![光電効果の概念図](images/81-install/photon.webp)
...
![時空の曲がり](images/81-install/emc2.webp)
:::
...
### 画像幅70%の例です。
![時空の曲がり](images/81-install/emc2.webp){width=70%}
